    ...
    return (
        <div className='Impressum'>
            ...
            <div class="Impressum-Container">
                ...
                <p>
                    Wir haben diese Datenschutzerklärung (Fassung 07.05.2024-112783974) verfasst,
                    um Ihnen gemäß der Vorgaben der Datenschutz-Grundverordnung (EU)
                    2016/679 und anwendbaren nationalen Gesetzen zu erklären, welche
                    personenbezogenen Daten (kurz Daten) wir als Verantwortliche – und die von uns
                    beauftragten Auftragsverarbeiter (z. B. Provider) – verarbeiten, zukünftig verarbeiten
                    ...
                    entsprechende gesetzliche Grundlage gegeben ist. Das ist sicher nicht möglich,
                    wenn man möglichst knappe, unklare und juristisch-technische Erklärungen abgibt,
                    so wie sie im Internet oft Standard sind, wenn es um Datenschutz geht. Ich hoffe, Sie
                    finden die folgenden Erläuterungen interessant und informativ und vielleicht ist die
                ...
                <p>
                    ...
                    meinen wir Informationen im Sinne des Art. 4 Nr. 1 DSGVO wie zum Beispiel Name,
                ...
                <p>
                    ...
                    EUR-Lex, dem Zugang zum EU-Recht, unter <a href="https://eur-lex.europa.eu/legalcontent/DE/ALL/?uri=celex%3A32016R0679">eur-lex.europa.eu/legalcontent</a> nachlesen.
                    Wir verarbeiten Ihre Daten nur, wenn mindestens eine der folgenden Bedingungen
                    zutrifft:
                    <ol>
                        <li>Einwilligung (Artikel 6 Absatz 1 lit. a DSGVO): Sie haben uns Ihre Einwilligung
                            gegeben, Daten zu einem bestimmten Zweck zu verarbeiten. Ein Beispiel
                            wäre die Speicherung Ihrer eingegebenen Daten eines Kontaktformulars.</li>
                        <li>
                        ...
                        <li>Rechtliche Verpflichtung (Artikel 6 Absatz 1 lit. c DSGVO): Wenn wir einer
                        ...
                        <li>
                            Berechtigte Interessen (Artikel 6 Absatz 1 lit. f DSGVO): Im Falle berechtigter
                    ...
                    Interessen treten bei uns in der Regel nicht auf. Soweit eine solche Rechtsgrundlage
                    doch einschlägig sein sollte, wird diese an der entsprechenden Stelle ausgewiesen.
                    Zusätzlich zu der EU-Verordnung gelten auch noch nationale Gesetze:
                    <ul>
                        <li>
                            In Österreich ist dies das Bundesgesetz zum Schutz natürlicher Personen bei
                            der Verarbeitung personenbezogener Daten (Datenschutzgesetz), kurz DSG.
                        </li>
                        <li>
